          ...
          <div className="py-4">
            ...
            <div className=" grid grid-cols-2 items-center w-full sm:w-4/5">
              <a
                ...
                href="https://mail.google.com/mail/?view=cm&to=official.shreshthav@gmail.com"
              >
                <img
                  loading="lazy"
                  src={Gmail}
              ...
              <a
                ...
                href="https://www.linkedin.com/in/shreshthav-bisht-50a36b20a/"
              >
                <img
                  loading="lazy"
                  src={Linked}
              ...
              <a
                ...
                className="md:p-3 w-full flex flex-col items-center justify-center focus:outline-none"
                href="https://www.instagram.com/shreshthavbishtt/"
              >
                <img
                  loading="lazy"
                  src={Instagram}
