      ...
      {!show ? (
        ...
        <div className="w-screen">
          ...
          <div
            ...
            className="flex h-[calc(100vh_-_6.1rem)] sm:h-[calc(100vh_-_6.6rem)] md:h-[calc(100vh_-_7.8rem)]  w-full bg-backgroundContact overflow-hidden bg-cover bg-right-bottom sm:bg-center bg-no-repeat"
          >
            <div
              data-aos="fade-right"
              data-aos-duration="1300"
              className="flex flex-col w-full md:w-1/2 lg:w-2/5 h-3/5 sm:h-1/2 md:h-full fixed md:static bottom-0 bg-[#3569D7] px-4 py-2 sm:py-0 overflow-y-auto justify-center"
            >
