...
import ProfileImage2 from "../assets/allAbout.jpg";
          ...
          <div className="col-span-3 lg:pr-10">
            <div className="flex flex-col">
                  ...
                  <>
                    <Disclosure.Button className="flex text-sm sm:text-base w-auto lg:w-full justify-between border-t border-gray-300 py-2 font-medium focus:outline-none ">
                      <span className="text-left">
                        What is Shreshthav Bisht' Education?
                      </span>
                      <FiChevronDown
                        className={`${
                    ...
                    <Disclosure.Panel className="pb-2">
                      <NavLink to="/education" className="flex flex-col group">
                        <p className="text-sm sm:text-base">
                          Bachelor Of Computer Application - Percentage(87.63%)
                          <br />
                          Master Of Computer Application - Percentage(81.30%)
                          ...
                        </p>
              ...
              <Disclosure>
                {({ open }) => (
                  <>
                    ...
                    >
                      <span className="text-left">
                        What are Shreshthav Bisht' Skills?
                      </span>
                      <FiChevronDown
                        className={`${
                          open ? "rotate-180 transform" : ""
              ...
              <Disclosure>
                {({ open }) => (
                  <>
                    ...
                    >
                      <span className="text-left">
                        How to contact Shreshthav Bisht?
                      </span>
                      <FiChevronDown
                        className={`${
                          open ? "rotate-180 transform" : ""
                    ...
                    <Disclosure.Panel className="pb-2 ">
                      <NavLink to="./contact" className="flex flex-col group">
                        <p className=" text-sm sm:text-base">
                          Gmail Id: official.shreshthav@gmail.com , ...
                        </p>
              ...
              <NavLink to="/education" className="flex flex-col group mt-8">
                ...
                <p className="text-sm text-[#65696E] mt-2">
                  Bachelor Of Computer Application- Percentage(87.63%) Master Of
                  Computer Application - Percentage(81.30%) ...
                </p>
              </NavLink>
            ...
            <div className="about flex flex-col mt-3">
              ...
              <p>
                <img
                  ...
                  alt="profileImage"
                />
                Greetings! I'm Shreshthav Bisht, an aspiring MERN (MongoDB,
                Express.js, React, Node.js) Stack Developer dedicated to
                professional growth. Currently pursuing MCA at Amity
                University(Noida). I'm your go-to Full Stack Developer, ready to
                bring your dream product to life in the virtual world. From
                crafting sleek websites for small-sized businesses to empowering
                you by building your dream tech product, I've got the skills and
                expertise to make it happen. With a mastery of JavaScript,
                React.js, Node.js, express.js, CSS and Next.js, I can help
                ensure your online presence stands out from the crowd. I am
                skilled in creating user-friendly interfaces, building RESTful
                APIs, and seamlessly integrating external services. Let's build
